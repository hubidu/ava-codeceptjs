...
test('running in browser should be able to use page objects', inBrowser(async (t, I) => {
...
test('running in browser errors in page objects should produce code excerpt, stacktrace of actual failed location and error screenshot', inBrowser(async (t, I) => {
  const DuckDuckGoPage = createDuckDuckGoPage(I)
