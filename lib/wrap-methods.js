...
const isAutowaitFunction = fnName => ['click', 'see', 'grabHTMLFrom', 'grabTextFrom', 'grabElementsFrom', 'fillField', 'switchTo'].indexOf(fnName) > -1
        ...
        try {
            ...
            if (isAutowaitFunction(fn.name) && isSelector(grabSelectorFromArgs(fn.name, args))
                ...
                try {
                    ...
                    await I.waitForVisible(grabSelectorFromArgs(fn.name, args))
                } catch (err) {
